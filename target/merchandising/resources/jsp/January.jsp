...
<head>
	...
	<script>
    		...
    		function sumjanuary()
    		{
    			document.form1.action="SumJanuary";
    			document.form1.submit();
    		}
    		function february()
    		{
...
<body style="background: #e1e9eb;">
	<div class="right">
		<div class="current">当前位置：<a href="javascript:void(0)" style="color:#6E6E6E;">销售展示</a> &gt; 一月份销售详情</div>
		<div class="rightCont">
			<form action="" method="get"  name="form1"> 
 				<p class="g_title">
					...
					<td><a onclick="january()" class="btn04" href="#">一月&nbsp;&nbsp;</a></td>
					<td><a onclick="february()" class="btn03" href="#">二月&nbsp;&nbsp;</a></td>
					<td><a onclick="march_GET()" class="btn03" href="#">三月&nbsp;&nbsp;</a></td>
					<td><a onclick="sumjanuary()" class="btn03" href="#">汇总&nbsp;&nbsp;</a></td>	
