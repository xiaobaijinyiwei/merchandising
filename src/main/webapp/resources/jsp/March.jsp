...
<head>
	...
	<script>
    		...
    		function summarch()
    		{
    			document.form1.action="SumMarch";
    			document.form1.submit();
    		}
		</script>
</head>
...
<body style="background: #e1e9eb;">
	...
	<div class="right">
		<div class="current">当前位置：<a href="javascript:void(0)" style="color:#6E6E6E;">销售展示</a> &gt; 三月份销售详情</div>
		<div class="rightCont">
			<form action="" method="get"  name="form1"> 
 				<p class="g_title">
					...
					<td><a onclick="march_GET()" class="btn04" href="#">三月 &nbsp;&nbsp;</a></td>
					<td><a onclick="summarch()" class="btn03" href="#">汇总 &nbsp;&nbsp;</a></td>	
